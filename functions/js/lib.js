function numbers() {
    const number1 = parseInt(prompt("choose a number."));
    const number2 = parseInt(prompt("choose another number."));
    const number3 = number1 + number2;
    alert(number1 + "+" + number2 + "=" + number3)
}

function rectangle() {
    const height = parseInt(prompt("What is the height of the rectangle."));
    const width = parseInt(prompt("What's the width of the rectangle."));
    const surface = height * width;
    alert("the surface is " + surface + " m2")
}

function workMemory() {
    const memory = parseInt(prompt("How much GB RAM do you have?"));
    if (memory > 4) {
...
function cricleSurface() {
    const radius = parseInt(prompt("What's the radius of the circle"));
    const surfaceCircle = 3.14 * (radius * radius);
    alert("The surface of the cirlce is" + surfaceCircle + "m2")
}

function math() {
    const no1 = parseInt(prompt("choose a number"));
    const no2 = parseInt(prompt("choose another number"));
    const result = ((no1 + no2) * (no1 + no2)) / ((no1 - no2)* (no1 - no2));
    alert(result)
}

function childrenMoney() {
    const childrenNumber = parseInt(prompt("How many children are you signing up to the music school"));
    let money;
    if (childrenNumber == 1) {
        money = 300
    }
...
function cost() {
    let pagesNumber = parseInt(prompt("how many pages do you want"))
